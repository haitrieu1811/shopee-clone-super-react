        ...
        <div className='grid grid-cols-12 gap-7'>
          ...
          <div className='col-span-12 lg:col-span-2'>
            <div className='flex items-center py-[15px]'>
              <img src={AvatarImage} alt='Avatar' className='h-12 w-12 flex-shrink-0 rounded-full object-cover' />
            ...
            <div className='mt-[27px]'>
              ...
              <div className='pb-[3px] pl-[32px]'>
                <Link to={''} className='mb-[15px] block text-sm capitalize text-gray-500 hover:text-orange'>
                  Hồ sơ
                </Link>
                <Link to={''} className='mb-[15px] block text-sm capitalize text-gray-500 hover:text-orange'>
                  Ngân hàng
              ...
              <Link to={''} className='mb-[15px] flex  items-center hover:text-orange'>
                <img src={NotificationImage} alt='' className='mr-[10px] h-5 w-5 flex-shrink-0 object-cover' />
                <h3 className='text-sm font-medium capitalize'>Thông báo</h3>
              </Link>
              <Link to={''} className='mb-[15px] flex  items-center hover:text-orange'>
                <img src={VoucherImage} alt='' className='mr-[10px] h-5 w-5 flex-shrink-0 object-cover' />
          ...
          <div className='col-span-12 rounded-sm bg-white px-[30px] pb-[10px] shadow lg:col-span-10 lg:ml-[27px]'>
            ...
            <div className='grid grid-cols-12 gap-6 pt-[30px]'>
              <div className='col-span-8 border-r-[1px] border-r-gray-200 pr-[50px]'>
                <form>
                  <div className='flex items-center pb-[30px]'>
                    <div className='w-[160px] pr-5 text-right text-sm text-gray-500'>Tên đăng nhập</div>
                  ...
                  <div className='flex items-center pb-[30px]'>
                    <div className='w-[160px] pr-5 text-right text-sm text-gray-500'>Số điện thoại</div>
              ...
              <div className='col-span-4 flex flex-col items-center'>
                <img src={AvatarImage} alt='' className='my-5 h-[100px] w-[100px] rounded-full object-cover' />
                <label>
